               ...
               <tr>
                <td valign=top align=middle>
                    ...
                    <?php if(is_array($auth_infoA)): $i = 0; $__LIST__ = $auth_infoA;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                            <td style="padding-left: 30px" background=<?php echo (ADMIN_IMG_URL); ?>menu_bt.jpg><a class=menuparent onclick=expand(<?php echo ($v['auth_id']); ?>) href="javascript:void(0);"><?php echo ($v['auth_name']); ?></a></td>
                        </tr>
                        <tr height=4>
                            <td></td>
                        </tr>
