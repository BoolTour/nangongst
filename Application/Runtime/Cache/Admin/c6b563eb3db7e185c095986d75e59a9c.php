...
<a href="/index.php/Admin/News/lst"><img src="<?php echo (ADMIN_IMG_URL); ?>icon_add.gif" align="left">成员列表</a></span>
...
<div class="form-div">
 ...
 <form action="/index.php/Admin/News/edit/id/2" method="post">
 <input type="hidden" name="id" value="<?php echo ($info['id']); ?>" />
    ...
    <tr>
        ...
        <td align="left" width="55%"><input type="text" name="title" value="<?php echo ($info['title']); ?>" /></td>
    </tr>
    <tr>
