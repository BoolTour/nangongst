...
<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1">---项目组成员</span>
<div style="clear:both"></div>
 ...
 <table width="100%" border="1" align="center" cellpadding="2" cellspacing="1" frame=box rules=none bordercolor="#99FF66">
    <tr class="tableHeader2">
        ...
        <td width="30%" align="center"><b>项目成员</b></td>
        <td width="30%" align="center"><b>电子邮件</b></td>
    ...
    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td align="center">
            <a href="/index.php/Admin/Charge/edit/id/<?php echo ($v['id']); ?>">修改</a>|
            <a href="/index.php/Admin/Charge/del/id/<?php echo ($v['id']); ?>">删除</a>
        <td>
