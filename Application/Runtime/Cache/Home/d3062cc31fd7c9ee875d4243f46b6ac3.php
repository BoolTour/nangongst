...
<div class="main">
	...
	<div class="right">
		...
		<div class="positioninfo">我的项目</div>
		<div class="mainarea">
			<table width="100%" border="0" cellspacing="1" cellpadding="3">
				<tbody>
                    <tr bgcolor="#ccc">
                        <td colspan="9" align="right"><a href="/index.php/Home/Project/tianjia">【添加组成员】</a></td>
                    </tr>
                	<tr style="font-weight: bold;">
                        <td>项目编号</td><td>项目名称</td><td>开始时间</td>
                        <td>结束时间</td><td>项目进度</td><td>是否批准</td>
                        <td colspan="2">操作</td>
                    </tr>
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr id="project">
                        ...
                        <td><?php echo ($v['pro_admit']?'是':'否'); ?></td>
                        <td>
                            <a href="/index.php/Home/Project/xiugai/id/<?php echo ($v['pro_id']); ?>">修改|
                            <a href="/index.php/Home/Project/shanchu/id/<?php echo ($v['pro_id']); ?>" onclick="return confirm('是否确认删除？');">删除
                        </td>
