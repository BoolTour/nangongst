...
<div class="main">
	...
	<div class="right">
		...
		<div style="background-color: #ccc;">
            <form action="/index.php/Home/Project/member" method="GET">
                <input type="hidden" name="p" value="1" />
                <img src="<?php echo (ADMIN_IMG_URL); ?>icon_search.gif" width="26" height="22" border="0" alt="SEARCH">
                <input type="text" name="pro_id" size="15" placeholder="项目编号" value="<?php echo I('get.pro_id'); ?>"/>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="3">
				<tbody>
                	<tr style="font-weight: bold;">
                        <td>编号</td><td>项目编号</td><td>项目成员</td>
                        <td>电子邮箱</td>
                    </tr>
